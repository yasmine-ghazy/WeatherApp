...
import com.iti.weatherapp.features.ui.alerts.AlertsViewModel
...
class ViewModelFactory : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        ...
        return when {
            ...
            //modelClass.isAssignableFrom(FavouritesViewModel::class.java) -> FavouritesViewModel() as T
            modelClass.isAssignableFrom(SettingsViewModel::class.java) -> SettingsViewModel() as T
            modelClass.isAssignableFrom(AlertsViewModel::class.java) -> AlertsViewModel(WeatherRepo) as T
